...
namespace LAB13
{
	public partial class Form1 : Form
	{
		...
		double p4;
		double p5;
		public double RandomDoubleInclusive()
		{
			double d = 0.0;
			int i = 0;
			do
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			for (m = 0; m < 5;)
			{
				...
				if (S < newLambda)
				{
					...
					double subtractionfrom1 = 1 - parameter;
					double powerofsubtraction = Math.Pow(subtractionfrom1, m);
			...
			int multiplier = 1000;
			int newp1 = (int)((p1 - (int)p1) * multiplier);
